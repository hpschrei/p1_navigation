...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, use_dueling=False,
                 use_double=False, fc1_units=64, fc2_units=64,
        ...
        self.use_prioritized_experience = use_prioritized_experience
        ...
        if self.use_prioritized_experience:
            self.memory = PrioritizedExperienceReplayBuffer(BATCH_SIZE, BUFFER_SIZE,
                                                            0, seed)
        else:
